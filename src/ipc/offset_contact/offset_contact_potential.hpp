...
class OffsetContactPotential {
public:
    OffsetContactPotential(const OffsetContactParameters& _params)
        : params(_params)
    {
    }

    virtual ~OffsetContactPotential() = default;
...
protected:
    ...
    OffsetContactParameters params;
};
