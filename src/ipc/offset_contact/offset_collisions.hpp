...
#include <ipc/offset_contact/collisions/offset_collision.hpp>

namespace ipc {
class OffsetCollisions {
public:
    /// @brief The type of the collisions.
    using value_type = OffsetCollision;

public:
    OffsetCollisions() = default;
    virtual ~OffsetCollisions() = default;
